...
export function RegisterLoginData() {
  ...
  async function handleRegister(formData: FormData) {
    ...
    const atualData = JSON.parse(await AsyncStorage.getItem(dataKey))

    if (atualData) {
      if (Array.isArray(atualData)) {
        await AsyncStorage.setItem(dataKey, JSON.stringify([...atualData, newLoginData]))
      } else {
        await AsyncStorage.setItem(dataKey, JSON.stringify([atualData, newLoginData]))
      }
    } else {
